...
//以流水號秀出某筆tad_discuss_board資料內容
function show_one_tad_discuss_board($BoardID=""){
	...
	<tr><th nowrap>"._MA_TADDISCUS_BOARDMANAGER."</th><td>{$BoardManager}
	<tr><td colspan=2>{$BoardDesc}</td></tr></td></tr>
	</table>";

	//raised,corners,inset
	$main=div_3d($BoardTitle,$data,"corners");
