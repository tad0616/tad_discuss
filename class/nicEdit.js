...
var nicEditorConfig = bkClass.extend({
	buttons : {
		'bold' : {name : __('粗體'), command : 'Bold', tags : ['B','STRONG'], css : {'font-weight' : 'bold'}, key : 'b'},
		'italic' : {name : __('斜體'), command : 'Italic', tags : ['EM','I'], css : {'font-style' : 'italic'}, key : 'i'},
		'underline' : {name : __('底線'), command : 'Underline', tags : ['U'], css : {'text-decoration' : 'underline'}, key : 'u'},
		'left' : {name : __('靠左'), command : 'justifyleft', noActive : true},
		'center' : {name : __('置中'), command : 'justifycenter', noActive : true},
		'right' : {name : __('靠右'), command : 'justifyright', noActive : true},
		'justify' : {name : __('左右對齊'), command : 'justifyfull', noActive : true},
		'ol' : {name : __('有序清單'), command : 'insertorderedlist', tags : ['OL']},
		'ul' : 	{name : __('無序清單'), command : 'insertunorderedlist', tags : ['UL']},
		'subscript' : {name : __('下標'), command : 'subscript', tags : ['SUB']},
		'superscript' : {name : __('上標'), command : 'superscript', tags : ['SUP']},
		'strikethrough' : {name : __('刪除線'), command : 'strikeThrough', css : {'text-decoration' : 'line-through'}},
		'removeformat' : {name : __('清除格式'), command : 'removeformat', noActive : true},
		'indent' : {name : __('縮排'), command : 'indent', noActive : true},
		'outdent' : {name : __('移除縮排'), command : 'outdent', noActive : true},
		'hr' : {name : __('水平線'), command : 'insertHorizontalRule', noActive : true}
	},
	iconsPath : 'class/nicEditorIcons.gif',
	buttonList : ['save','bold','italic','underline','strikethrough','left','center','right','justify','fontSize','image','upload','link','unlink','forecolor','bgcolor','ol','ul','removeformat','xhtml'],
...
var nicSelectOptions = {
	buttons : {
		'fontSize' : {name : __('文字大小'), type : 'nicEditorFontSizeSelect', command : 'fontsize'},
		'fontFamily' : {name : __('文字字型'), type : 'nicEditorFontFamilySelect', command : 'fontname'},
		'fontFormat' : {name : __('文字樣式'), type : 'nicEditorFontFormatSelect', command : 'formatBlock'}
	}
};
/* END CONFIG */
...
var nicLinkOptions = {
	buttons : {
		'link' : {name : '加入連結', type : 'nicLinkButton', tags : ['A']},
		'unlink' : {name : '移除連結',  command : 'unlink', noActive : true}
	}
};
/* END CONFIG */
...
var nicLinkButton = nicEditorAdvancedButton.extend({	
	addPane : function() {
		...
		this.addForm({
			'' : {type : 'title', txt : '加上/編輯連結'},
			'href' : {type : 'text', txt : '網址', value : 'http://', style : {width: '150px'}},
			'title' : {type : 'text', txt : '說明'},
			'target' : {type : 'select', txt : '開啟至', options : {'' : '目前視窗', '_blank' : '新視窗'},style : {width : '100px'}}
		},this.ln);
	},
...
var nicColorOptions = {
	buttons : {
		'forecolor' : {name : __('文字顏色'), type : 'nicEditorColorButton', noClose : true},
		'bgcolor' : {name : __('背景顏色'), type : 'nicEditorBgColorButton', noClose : true}
	}
};
/* END CONFIG */
...
var nicImageOptions = {
	buttons : {
		'image' : {name : '插入圖片', type : 'nicImageButton', tags : ['IMG']}
	}
...
var nicImageButton = nicEditorAdvancedButton.extend({	
	addPane : function() {
		...
		this.addForm({
			'' : {type : 'title', txt : '插入/編輯圖片'},
			'src' : {type : 'text', txt : '圖網址', 'value' : 'http://', style : {width: '150px'}},
			'alt' : {type : 'text', txt : '圖說明', style : {width: '100px'}},
			'align' : {type : 'select', txt : '圖位置', options : {none : '預設','left' : '靠左文繞圖', 'right' : '靠右文繞圖'}}
		},this.im);
	},
...
var nicSaveOptions = {
	buttons : {
		'save' : {name : __('儲存'), type : 'nicEditorSaveButton'}
	}
};
/* END CONFIG */
...
var nicUploadOptions = {
	buttons : {
		'upload' : {name : '上傳圖片', type : 'nicUploadButton'}
	}
  ...
  errorText : 'Failed to upload image',
    ...
    var container = new bkElement('div')
      ...
      .appendTo(this.pane.pane);
		...
		new bkElement('div')
      .setStyle({ fontSize: '12px', color : 'blue', paddingBottom: '5px' })
      .setContent('上傳圖片至imgur.com（三個月若無人看會自動刪圖）')
      .appendTo(container);
...
var nicCodeOptions = {
	buttons : {
		'xhtml' : {name : '原始碼', type : 'nicCodeButton'}
	}
