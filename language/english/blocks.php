...
define('_MB_TADDISCUS_TAD_DISCUSS_NEW_EDIT_BITEM0', 'Shows the number of discussion');

define('_MB_TADDISCUS_TAD_DISCUSS_HOT_EDIT_BITEM0', 'Shows the number of discussion');
define('_MB_TADDISCUS_TAD_DISCUSS_HOT_EDIT_BITEM1', 'Includ only articles within a few days');
