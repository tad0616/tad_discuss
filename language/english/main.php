...
define('_MD_TADDISCUS_NEED_BOARDID', 'Please select on menu from the top of the drop-down to select an appropriate forum to post messages, or press <button type=\'button\' style=\'font-size: 80%;border:1px solid gray;\'>' . _MD_TADDISCUS_DISCUSSRE . '</button>  also line!');
