    ...
    <table class="table table-striped table-hover">
      ...
      <{foreach from=$all_content item=data}>
        <tr id="tr_<{$data.setupID}>">
          ...
          <td>
            <a href="javascript:delete_tad_discuss_cbox_setup_func(<{$data.setupID}>);" class="btn btn-xs btn-danger"><{$smarty.const._TAD_DEL}></a>
            <a href="<{$action}>?op=tad_discuss_cbox_setup_form&setupID=<{$data.setupID}>" class="btn btn-xs btn-warning"><{$smarty.const._TAD_EDIT}></a>
          </td>
        </tr>
      <{/foreach}>
      </tbody>
