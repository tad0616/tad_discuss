...
<div class="container-fluid">
  ...
  <{elseif $op=='listBoard'}>
    ...
    <form action="copybb.php" method="post" role="form">
    ...
    <{foreach item=bb from=$all_content}>
      <tr>
        <td><{$bb.i}></td>
        <td><a href="copybb.php?op=delXforum&topic_id=<{$bb.topic_id}>&BoardID=<{$bb.BoardID}>" class="btn btn-sm btn-danger"><{$smarty.const._TAD_DEL}></a></td>
        <td><{$bb.topic_id}></td>
