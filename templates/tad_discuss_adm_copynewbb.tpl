<div class="container-fluid">
  ...
  <{elseif $op=='listBoard'}>
    ...
    <a href="copynewbb.php?op=copyDiscuss&BoardID=<{$BoardID|default:''}>" class="btn btn-lg btn-info"><{$smarty.const._MA_TADDISCUS_COPY_DISCUSS}></a>
    <a href="copynewbb.php?op=copyDiscuss&BoardID=<{$BoardID|default:''}>&mode=force" class="btn btn-lg btn-warning"><{$smarty.const._MA_TADDISCUS_COPY_DISCUSS_FORCE}></a>
    </div>
    ...
    <button type="submit" class="btn btn-large btn-danger pull-right float-right pull-end"><{$smarty.const._MA_TADDISCUS_BATCH_DEL}></button>
    </form>
    <div class="clearfix"></div>
