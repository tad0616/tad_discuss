...
<{if $discuss.dir!="top"}>
  <div class="triangle-border talk" style="line-height:150%;margin:26px 0px 16px;background-color:<{if $discuss.onlyTo|default:false}>#FEEDD3<{else}>white<{/if}>;">
...
<{if $discuss.dir=="top"}>
  <div class="triangle-border top talk" style="line-height:150%;background-color:<{if $discuss.onlyTo|default:false}>#FEEDD3<{else}>white<{/if}>;">
    <{$discuss.DiscussContent}>
    <br><{$discuss.files}><span style="width:96%;display:block;margin:10px auto 0px;padding:2px 8px;font-size: 75%;color:silver;text-align:right;">
